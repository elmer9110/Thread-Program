...
static void classa_leave() 
{
   ...
   */
  /*
    Check that uses a mutex in order to prevent students from
    class b entering the office while a student from class a
    is inside, Vice-versa.
  */
  students_in_office -= 1;
  classa_inoffice -= 1;
